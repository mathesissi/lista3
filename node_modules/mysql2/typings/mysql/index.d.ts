import { Pool as BasePool, PoolOptions } from 'mysql2/typings/mysql/lib/Pool.js';
import {
  Connection as BaseConnection,
  ConnectionOptions,
  SslOptions,
} from 'mysql2/typings/mysql/lib/Connection.js';
import {
  Query as BaseQuery,
  QueryOptions,
  QueryError,
} from 'mysql2/typings/mysql/lib/protocol/sequences/Query.js';
import {
  PoolCluster as BasePoolCluster,
  PoolClusterOptions,
  PoolNamespace,
} from 'mysql2/typings/mysql/lib/PoolCluster.js';
import { PoolConnection as BasePoolConnection } from 'mysql2/typings/mysql/lib/PoolConnection.js';
import {
  Prepare as BasePrepare,
  PrepareStatementInfo,
} from 'mysql2/typings/mysql/lib/protocol/sequences/Prepare.js';
...
export * from 'mysql2/typings/mysql/lib/protocol/packets/index.js';
export * from 'mysql2/typings/mysql/lib/Auth.js';
export * from 'mysql2/typings/mysql/lib/constants/index.js';
export * from 'mysql2/typings/mysql/lib/parsers/index.js';
